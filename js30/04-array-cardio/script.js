...
console.log("Inventors born in 1500s: ", inventors.filter( inventor => 
    inventor.year >= 1500 && inventor.year < 1600
    // keep in mind return can be omitted if only one statement inside arrow f'n
    // if curly braces are used to enclose f'n body, return is necessary
));

// Array.prototype.map()
// 2. Give us an array of the inventors first and last names
console.log("Inventors full names: ", inventors.map( inventor => 
    inventor.first + " " + inventor.last
));

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
console.log("Inventors sorted in descending order of birthdate", inventors.sort((a, b) => 
    b.year - a.year
));

// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
console.log("Total years lived by all inventors", inventors.reduce((sum, inventor) => 
    sum += (inventor.passed - inventor.year)
, 0));

// 5. Sort the inventors by years lived
console.log("Inventors sorted in ascending order of years lived", 
    inventors.sort((a, b) => {
        a.age = (a.passed - a.year);
        // not setting age property for b cause sort will loop thru all elements and create anyways
        return a.age - (b.passed - b.year);
    })
);
...
// run this in above page to get list of boulevard names 
// [...document.querySelectorAll('div.mw-category li a')].map(anchor => anchor.innerText)
...
console.log("Boulevards with 'de' in the names", boulevards.filter(boulevard => 
    /de/.test(boulevard)
));

// 7. sort Exercise
// Sort the people alphabetically by last name
console.log("People sorted in ascending order of last name", people.sort());
